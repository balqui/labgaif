...
Heavy refactoring of ../redecomp.py 0.1 gamma from the 
alternative view that we work only on clans, which store
their own type on themselves, instead of having the three 
separate concepts of clan, singleton, and decomposition tree.
